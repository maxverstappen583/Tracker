...
.skills img{width:40px;height:40px;border-radius:8px;padding:4px;background:linear-gradient(180deg, rgba(255,255,255,0.02), transparent);object-fit:contain}
...
.btn.contact{background:var(--accent-2)}
.btn.view-bot{background:var(--accent)}
...
@media (max-width:900px){
  ...
  .skills img{width:36px;height:36px;padding:3px}
}
